将上传的图片严格作为唯一的内容来源和摄影原片使用。根据 [output-formats.md](output-formats.md) 中选择的作品形态，生成“原照片区域＋抽象记忆面板＋诗意标题”的完整编辑作品、独立的照片衍生抽象作品，或同时包含两者的配套组合。不得生成与照片无关的抽象画，也不得直接对照片应用滤镜。
